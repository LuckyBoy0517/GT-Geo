...
class SGFormer1(nn.Module):
    def __init__(self, in_channels, hidden_channels, num_layers=2, num_heads=1, 
        ...
        self.trans_conv2 = TransConv(hidden_channels,hidden_channels,num_layers,num_heads,alpha,dropout,use_bn,use_residual,use_weight)
        self.trans_conv3 = TransConv(hidden_channels,hidden_channels,num_layers,num_heads,alpha,dropout,use_bn,use_residual,use_weight)
    ...
    def reset_parameters(self):
        ...
        self.trans_conv3.reset_parameters()
